export { default as ChildRoom } from './child-room.jpg';
export { default as JapaneseStreet } from './japanese-street.jpg';
export { default as LiveRoom } from './living-room.jpg';
